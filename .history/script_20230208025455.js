function addHistory(city) {
    ...
    var searchDisplay = document.getElementById("search-history");
    ...
    btn.addEventListener("click", fetchWeather2(city));
}
    

    var oldCities = localStorage.getItem("cities");
...
function fetchWeather(inputTxt)
{
...
function fetchWeather2(inputTxt)
{
    var APIKEY = '3d90c1ba80e1377a6db30bdf0b2f1488';
    var searchBtn = document.getElementById("search-btn");
    searchBtn.addEventListener("click", () => {
